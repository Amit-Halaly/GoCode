...
class LanguagePathFragment : Fragment(R.layout.fragment_language_path) {
    ...
    private fun sectionInfo(sectionNumber: Int): SectionInfo {
        ...
        val isCSharp = language.lowercase() == "csharp"
        return when (sectionNumber) {
            ...
            6 -> SectionInfo(6, if (isPython) "Input" else if (isC) "scanf Input" else if (isCpp) "cin Input" else if (isCSharp) "Console Input" else "Scanner Input", R.color.section_six)
