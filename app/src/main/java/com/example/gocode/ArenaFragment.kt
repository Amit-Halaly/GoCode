...
String b = "Code";
System.out.println(a + b);""",
                options = listOf("""Go Code""", """GoCode""", """CodeGo""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(s + s);""",
                options = listOf("""catcat""", """cat s""", """s s""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(n >= 10);""",
                options = listOf("""true""", """false""", """9""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(x++);
System.out.println(x);""",
                options = listOf("""2 then 2""", """2 then 3""", """3 then 3""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
if (x % 2 == 0) System.out.println("even");
                ...
                options = listOf("""even""", """odd""", """true""", """4"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(s.contains("eve"));""",
                options = listOf("""true""", """false""", """eve""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(a > b ? a : b);""",
                options = listOf("""3""", """4""", """true""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println("Hi".toLowerCase());""",
                options = listOf("""Hi""", """HI""", """hi""", """Compilation error"""),
                correctIndex = 2
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(s.equals("ABC"));""",
                options = listOf("""true""", """false""", """abc""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(x > 3 && x < 5);""",
                options = listOf("""true""", """false""", """6""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(x + y + "x" + y);""",
                options = listOf("""3x2""", """12x2""", """3xy""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println("x" + 1 + 2 + 3);""",
                options = listOf("""x6""", """x123""", """6x""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(x++ == 0 && x == 1);""",
                options = listOf("""true""", """false""", """1""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Java""",
...
int x = -5;
System.out.println(x % 2);""",
                options = listOf("""1""", """-1""", """0""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
b[0] = 9;
System.out.println(a[0]);""",
                options = listOf("""1""", """2""", """9""", """Compilation error"""),
                correctIndex = 2
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println((int) 3.9);""",
                options = listOf("""3""", """4""", """3.9""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Java""",
...
System.out.println(d);""",
                options = listOf("""2""", """2.0""", """2.5""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Java""",
...
b = 'Code'
print(a + b)""",
                options = listOf("""Go Code""", """GoCode""", """CodeGo""", """Error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Python""",
...
s = 'cat'
print(s + s)""",
                options = listOf("""catcat""", """cat s""", """s s""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
...
n = 9
print(n >= 10)""",
                options = listOf("""True""", """False""", """9""", """Error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Python""",
...
s = 'level'
print('eve' in s)""",
                options = listOf("""True""", """False""", """eve""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
...
s = 'abc'
print(s == 'ABC')""",
                options = listOf("""True""", """False""", """abc""", """Error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Python""",
...
x = 6
print(x > 3 and x < 5)""",
                options = listOf("""True""", """False""", """6""", """Error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Python""",
...
print(list(range(2, 8, 2)))""",
                options = listOf("""[2, 4, 6]""", """[2, 4, 6, 8]""", """[0, 2, 4, 6]""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
...
print(str(x + y) + 'x' + str(y))""",
                options = listOf("""3x2""", """12x2""", """3xy""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
                ...
                prompt = """What is printed?
print('x' + str(1 + 2 + 3))""",
                options = listOf("""x6""", """x123""", """6x""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
...
x = 0
print(x == 0 and x + 1 == 1)""",
                options = listOf("""True""", """False""", """1""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
...
print('abc'.replace('a', 'z'))""",
                options = listOf("""abc""", """zbc""", """azbc""", """Error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """Python""",
...
print(int(3.9))""",
            ...
            ArenaQuestion(
                ...
                prompt = """What is printed?
print(5 / 2 == 2.5)""",
                options = listOf("""True""", """False""", """2.5""", """Error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """Python""",
...
int ok = 0;
printf("%d", ok);""",
                options = listOf("""1""", """0""", """false""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """C""",
...
char s[] = "cat";
printf("%s", s);""",
                options = listOf("""cat""", """s""", """c""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """C""",
...
int n = 9;
printf("%d", n >= 10);""",
                options = listOf("""1""", """0""", """9""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """C""",
...
printf("%d", strchr("level", 'e') != NULL);""",
                options = listOf("""1""", """0""", """e""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """C""",
...
int b = 4;
printf("%d", a > b ? a : b);""",
                options = listOf("""3""", """4""", """1""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """C""",
...
printf("%d", strcmp("abc", "ABC") == 0);""",
                options = listOf("""1""", """0""", """abc""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """C""",
...
int x = 6;
printf("%d", x > 3 && x < 5);""",
                options = listOf("""1""", """0""", """6""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """C""",
...
int *p = a;
printf("%d", *(p + 2));""",
                options = listOf("""1""", """2""", """3""", """Compilation error"""),
                correctIndex = 2
            ),
            ArenaQuestion(
                language = """C""",
...
char s[] = "abc";
printf("%c", *(s + 2));""",
                options = listOf("""a""", """b""", """c""", """Compilation error"""),
                correctIndex = 2
            ),
            ArenaQuestion(
                language = """C""",
...
int x = 0;
printf("%d", x == 0 && x + 1 == 1);""",
                options = listOf("""1""", """0""", """2""", """Compilation error"""),
                correctIndex = 0
            ),
            ArenaQuestion(
                language = """C""",
...
int b = 2;
printf("%d %d", a, b += 3);""",
                options = listOf("""1 2""", """1 5""", """4 5""", """Compilation error"""),
                correctIndex = 1
            ),
            ArenaQuestion(
                language = """C""",
